...
# if schoolGrade >= 7: #nested if conditionals
#   print("passed")
# else:
#   print("failed")
...
# #enter yout relatives name
# relativeName = input("what is your relatives name? ")
# #enter your age
...
# elif age < 30:
#   print("u are a vicenarian")
# #if age is less than 40 print i am a tricenarian
# elif age < 40:
#   print("u are a tricenarian")
# #if age is less than 50 print i am a quadragenarian
# elif age < 50:
#   print("u are a quadragenarian")
# #if age is less than 60 print i am old
# else:
#   print("u are old")
